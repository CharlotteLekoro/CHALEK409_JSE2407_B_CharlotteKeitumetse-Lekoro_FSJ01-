export default function ProductSkeleton() {
    return (
      <div
        role="status"
        className="space-y-8 mt-6 sm:mt-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center"
      >
        <div className="flex items-center justify-center w-full h-96 bg-gray-400 rounded sm:w-96 dark:bg-gray-700">
          <svg
        ...
        <div className="w-full -mt-10">
          <div className="h-4 bg-gray-400 rounded-full dark:bg-gray-700 max-w-[660px] mb-2.5"></div>
